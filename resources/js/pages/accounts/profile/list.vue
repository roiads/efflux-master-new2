<template>
  <b-container fluid>
    ...
    <b-card no-body class="p-2 bg-gradient-gray">
      <b-row>
    ...
    <b-card no-body>
      ...
      <vue-pagination :pagination="profiles" @paginate="getProfiles()"></vue-pagination>
    </b-card>
  </b-container>
</template>
...
export default {
  ...
  methods: {
    ...
    getProfiles() {
      axios
        .get(`/accounts/profile?page=${this.profiles.current_page}`)
