<template>
  <div class="col-sm-8 col-lg-9" id="user-overview">
    <div class="row" v-if="user.id">
      <stat-box bg="primary" size="col-sm-11 col-md-10 col-lg-9" :header="user.first_name+' '+user.last_name" url="#" :message="user.email" icon="user" footer="Edit Permissions..."></stat-box>
