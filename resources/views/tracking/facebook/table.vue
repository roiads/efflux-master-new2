  ...
  <div class="col-sm-4 list-comp">
    <div class="card card-light">
      ...
      <div class="card-body p-0">
        ...
        <x-pagination :pagination="posts" @paginate="getPosts()"></x-pagination>
      </div>
    </div>
    <div class="card card-light" v-if="selectedPost.id" style="flex-grow: 1">
...
export default {
  ...
  methods: {
    ...
    getPosts() {
      axios
        .get(`/site/post?page=${this.posts.current_page}`)
