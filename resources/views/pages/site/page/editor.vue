<template>
  <div class="col-sm-8 editor">
    <div class="card animated fadeInRight fast card-light" v-if="page.html" style="height: 100%">
  ...
  watch: {
    page: function(newVal, oldVal) {
      ...
      if (!this.editor) {
        ...
        this.editor.setComponents(this.sanitize(this.page.html));
  ...
  methods: {
    ...
    init(data) {
      requestAnimationFrame(() => {
        ...
        this.editor.setComponents(this.sanitize(data.html));
